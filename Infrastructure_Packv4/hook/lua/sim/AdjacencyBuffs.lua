...
################################################################################
## T3 Mass & Energy Storage Production Bonus
################################################################################

T3MassEnergyStorageAdjacencyBuffs = {
    'T3EnergyMassStorageEnergyProductionBonusSize4',
    'T3EnergyMassStorageEnergyProductionBonusSize8',
    'T3EnergyMassStorageEnergyProductionBonusSize12',
    'T3EnergyMassStorageEnergyProductionBonusSize16',
    'T3EnergyMassStorageEnergyProductionBonusSize20',
}

BuffBlueprint {
    Name = 'T3EnergyMassStorageEnergyProductionBonusSize4',
    DisplayName = 'T3EnergyStorageEnergyProductionBonus',
    BuffType = 'MASSBUILDBONUS',
    Stacks = 'ALWAYS',
    Duration = -1,
...
BuffBlueprint {
    Name = 'T3EnergyMassStorageEnergyProductionBonusSize8',
    DisplayName = 'T3EnergyStorageEnergyProductionBonus',
    BuffType = 'MASSBUILDBONUS',
    Stacks = 'ALWAYS',
    Duration = -1,
...
BuffBlueprint {
    Name = 'T3EnergyMassStorageEnergyProductionBonusSize12',
    DisplayName = 'T3EnergyStorageEnergyProductionBonus',
    BuffType = 'MASSBUILDBONUS',
    Stacks = 'ALWAYS',
    Duration = -1,
...
BuffBlueprint {
    Name = 'T3EnergyMassStorageEnergyProductionBonusSize16',
    DisplayName = 'T3EnergyStorageEnergyProductionBonus',
    BuffType = 'MASSBUILDBONUS',
    Stacks = 'ALWAYS',
    Duration = -1,
...
BuffBlueprint {
    Name = 'T3EnergyMassStorageEnergyProductionBonusSize20',
    DisplayName = 'T3EnergyStorageEnergyProductionBonus',
    BuffType = 'MASSBUILDBONUS',
    Stacks = 'ALWAYS',
    Duration = -1,
